         ...
         data: {id: id},
            ...
            success:function (data) {
             if($.isEmptyObject(data) != null){
                ...
                $("#bookName").text(data.name + "'s details :");
                $(".vname").text("Product Name : " + data.name);
                $(".vdescription").text("Product description : " + data.description);
                $(".vquantity").text("Product quantity : " + data.quantity);
